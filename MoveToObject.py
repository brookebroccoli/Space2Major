...
def MoveToObject(x,y,z,rx,ry,rz)
    ...
    # Test that the output is getting sent high, not actually needed for function
    # to work 
...
# Call the fucntion, we will need to recalibrate these values once we know the
# base reference frame of the UR5
MoveToObject(0.5,0.5,0.5,0,0,0)
