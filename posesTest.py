...
firstPose = np.append(np.array([xRange[0], frameCentre[1], yRange[0]]), np.array([centralPose[3], centralPose[4], centralPose[5]-thetaRange[0]]))
...
for y in yRange:
    ...
    for x in xRange:
        ...
        poses[i,j,:] = np.append(np.array([x, frameCentre[1], y]), np.array([centralPose[3], centralPose[4], centralPose[5]-thetaRange[i]]))
